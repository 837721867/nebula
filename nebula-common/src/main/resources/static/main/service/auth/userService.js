...
}).use(['index', 'auth/userListModule', 'table'], function () {
    ...
    var $ = layui.$, active = {
        batchdel: function () {
            ...
            layer.confirm('确定删除吗？', function (index) {
                ...
                // 执行 Ajax 后重载
                $.ajax({
                    url: rootUrl + "/uqiansoftAdmin/auth/user/delete",
                    type: "post",
                    cache: false,
                    dataType: "json",
                    data: {userIds: userStr},
                    async: false,
        ...
        add: function () {
            ...
            layer.open({
                ...
                , yes: function (index, layero) {
                    ...
                    var submit = layero.find('iframe').contents().find("#layuiadmin-app-user-submit");
                    submit.click();
                }
            });
        }
    ...
    var setting = {
        ...
        callback: {
            ...
            onClick: function (event, treeId, treeNode) {
                ...
                layui.table.reload('LAY-app-user-list', {
                    where: {
