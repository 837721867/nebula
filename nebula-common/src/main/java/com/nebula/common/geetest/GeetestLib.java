...
public class GeetestLib {
    ...
    private int registerChallenge(HashMap<String, String> data) {
        try {
            ...
            param = buildParam(userId, clientType, ipAddress, param);
            ...
            String return_challenge = jsonObject.getAsJsonObject().get("challenge").getAsString();
     ...
     */
    private String buildParam(String userId, String clientType, String ipAddress, String param) throws UnsupportedEncodingException {
        if (userId != null) {
    ...
    public int enhencedValidateRequest(String challenge, String validate, String seccode, HashMap<String, String> data) throws UnsupportedEncodingException {
        ...
        return_seccode = return_map.getAsJsonObject().get("seccode").getAsString();
    ...
    private String readContentFromGet(String URL) throws IOException {
        ...
        return getResultString(connection);
    }
    ...
    /**
     * 自己改造获取POST请求，获取服务器返回结果
     * @param connection
     * @return
     * @throws IOException
     */
    private String getResultString(HttpURLConnection connection) throws IOException {
